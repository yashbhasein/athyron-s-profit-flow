...
const HowItWorksSection = () => {
  return <div className="mb-20 overflow-visible">
      <motion.div initial={{
      opacity: 0,
      y: 30
    }} whileInView={{
      ...
      once: true
        ...
        <h3 className="text-2xl md:text-3xl font-bold mb-4">
          <span className="text-foreground">Any Machine. One Device. </span>{" "}
      ...
      <div className="relative overflow-visible py-8">
        ...
        <div className="hidden lg:block absolute top-1/2 left-[8%] right-[8%] h-1 -translate-y-1/2 z-0">
          ...
          <motion.div className="absolute top-0 left-0 h-full bg-gradient-to-r from-primary via-success via-warning to-accent rounded-full" initial={{
          width: "0%"
        }} whileInView={{
          width: "100%"
        }} transition={{
